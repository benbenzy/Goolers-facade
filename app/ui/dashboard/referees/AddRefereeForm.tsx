'use client';
import { PlayerFormPost, RefereeFormPost } from '@/app/types/types.d';
...
interface props {
  submit: SubmitHandler<RefereeFormPost>;
}

const AddRefereeForm: FC<props> = ({ submit }) => {
  const supabase = createClient();
  const { register, handleSubmit, watch } = useForm<RefereeFormPost>();
