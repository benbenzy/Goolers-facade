'use client';
import { CaptainFormPost, VenueFormPost } from '@/app/types/types.d';
...
interface props {
  submit: SubmitHandler<VenueFormPost>;
}

const AddVenueForm: FC<props> = ({ submit }) => {
  const supabase = createClient();
  const { register, handleSubmit, watch } = useForm<VenueFormPost>();
